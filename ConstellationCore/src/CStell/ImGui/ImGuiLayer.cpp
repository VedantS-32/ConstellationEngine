...
namespace CStell
{
	...
	void ImGuiLayer::SetDarkThemeColors()
	{
		...
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.9570815563201904f, 0.6161469221115112f, 0.7829567193984985f, 1.0f);
		...
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.8941176533699036f, 0.3450980484485626f, 0.4705882370471954f, 1.0f);
		...
		style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(1.0f, 0.3019607961177826f, 0.4627451002597809f, 0.5333333611488342f);
		...
		style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(1.0f, 0.301960825920105f, 0.4277878403663635f, 1.0f);
		...
		style.Colors[ImGuiCol_TabHovered] = ImVec4(0.8941176533699036f, 0.3450980484485626f, 0.4705882370471954f, 1.0f);
		...
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.8884119987487793f, 0.465177059173584f, 0.5959622859954834f, 1.0f);
